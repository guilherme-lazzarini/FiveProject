...
AddEventHandler("ks-character:characterCreate",function()
	doStatus = 1
...
function refreshDefaultCharacter()
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(),7,0,0,1)
		SetPedComponentVariation(PlayerPedId(),3,15,0,1)
		SetPedComponentVariation(PlayerPedId(),4,16,0,1)
		SetPedComponentVariation(PlayerPedId(),8,15,0,2)
		SetPedComponentVariation(PlayerPedId(),6,34,0,1)
		SetPedComponentVariation(PlayerPedId(),11,15,0,1)
		...
		SetPedComponentVariation(PlayerPedId(),3,15,0,1)
		SetPedComponentVariation(PlayerPedId(),4,16,0,1)
		SetPedComponentVariation(PlayerPedId(),8,15,25,1)
		SetPedComponentVariation(PlayerPedId(),6,35,0,1)
		SetPedComponentVariation(PlayerPedId(),11,74,1,1)
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	SetEntityCoordsNoOffset(PlayerPedId(),-1848.74,-1230.67,13.02+0.001,true,true,true)
	...
	TriggerServerEvent("ks-character:finishedCharacter",characterNome, characterSobrenome, characterAge,currentCharacterMode)
end)
