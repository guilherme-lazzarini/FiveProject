...
Config.Language = {
	joining = "[PVPAS] Entrando...",
	connecting = "[PVPAS] Conectando...",
	err = "[PVPAS] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[PVPAS] Você foi desconectado por demorar demais na fila.",
	pos = "Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[PVPAS] Não foi possível adiciona-lo na fila.",
    wlonly = "[PVPAS] Você não está aprovado na whitelist.",
	banned = "[PVPAS] Seu passaporte foi revogado na cidade.",
	steam = "[PVPAS] Você precisa estar com a Steam aberta para conectar."
}
